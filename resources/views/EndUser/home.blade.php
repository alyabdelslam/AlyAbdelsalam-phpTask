          ...
          <div class="ts-service-box">
              ...
              <div class="d-flex">
                ...
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="{{route('service')}}">Web Development</a></h3>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
          <div class="ts-service-box">
              ...
              <div class="d-flex">
                ...
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="{{route('service')}}">Mobile App Development</a></h3>
                    <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                    <a class="learn-more d-inline-block" href="{{route('service')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
          <div class="ts-service-box">
              ...
              <div class="d-flex">
                ...
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="{{route('service')}}">Graphics</a></h3>
                    <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                    <a class="learn-more d-inline-block" href="{{route('service')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                </div>
              </div>
    ...
    <div class="col-lg-4 col-md-6 mb-5">
      <div class="ts-service-box">
          ...
          <div class="d-flex">
            ...
            <div class="ts-service-info">
                <h3 class="service-box-title"><a href="{{route('service')}}">Video Editing</a></h3>
                <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                <a class="learn-more d-inline-block" href="{{route('service')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
            </div>
          </div>
              ...
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">
                    <a href="{{route('project')}}">Capital Teltway Building</a>
                  </h3>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
            <div class="project-img-container">
              ...
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">
                    <a href="{{route('project')}}">Ghum Touch Hospital</a>
                  </h3>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;infrastructure&quot;,&quot;commercial&quot;]">
            <div class="project-img-container">
              ...
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">
                    <a href="{{route('project')}}">TNT East Facility</a>
                  </h3>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;education&quot;,&quot;infrastructure&quot;]">
            <div class="project-img-container">
              ...
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">
                    <a href="{{route('project')}}l">Narriot Headquarters</a>
                  </h3>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
            <div class="project-img-container">
              ...
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">
                    <a href="{{route('project')}}">Ancraft Avenue House</a>
                  </h3>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              <div class="latest-post-media">
                <a href="{{route('event')}}" class="latest-post-img">
                    <img loading="lazy" class="img-fluid" src="images/news/news1.jpg" alt="img">
                </a>
              </div>
              <div class="post-body">
                <h4 class="post-title">
                    <a href="{{route('event')}}" class="d-inline-block">We Just Completes $17.6 million Medical Clinic in Mid-Missouri</a>
                </h4>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              ...
              <div class="post-body">
                <h4 class="post-title">
                    <a href="{{route('event')}}" class="d-inline-block">Thandler Airport Water Reclamation Facility Expansion Project Named</a>
                </h4>
                <div class="latest-post-meta">
                    <span class="post-item-date">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              ...
              <div class="post-body">
                <h4 class="post-title">
                    <a href="{{route('event')}}" class="d-inline-block">Silicon Bench and Cornike Begin Construction Solar Facilities</a>
                </h4>
                <div class="latest-post-meta">
                    <span class="post-item-date">
