      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
            ...
            <ul class="list-arrow">
              <li><a href="{{route('service')}}">Pre-Construction</a></li>
              <li><a href="{{route('service')}}">General Contracting</a></li>
              <li><a href="{{route('service')}}">Construction Management</a></li>
              <li><a href="{{route('service')}}">Design and Build</a></li>
              <li><a href="{{route('service')}}">Self-Perform Construction</a></li>
            </ul>
          </div><!-- Col end -->
        </div><!-- Row end -->
      </div><!-- Container end -->
